    ...
    <div className="lg:col-span-2 premium-card p-7">
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          ...
          <p className="text-xs text-atlas-text-muted mt-0.5">Your learning journey this week</p>
        </div>
      </div>
          ...
          return (
            <div key={activity.id} className="flex items-start gap-4 group">
              <div className="relative flex flex-col items-center">
                ...
                {!isLast && <div className="w-px h-full bg-atlas-border/40 mt-2" />}
              </div>
              <div className={cn("flex-1", !isLast && "pb-4")}>
                <div className="flex items-center justify-between mb-1">
                  ...
                  <span className="text-xs text-atlas-text-muted tabular-nums">{activity.timestamp}</span>
                </div>
